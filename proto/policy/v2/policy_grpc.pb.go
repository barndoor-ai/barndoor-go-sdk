...
func (UnimplementedPolicyServiceServer) ClonePolicy(context.Context, *ClonePolicyRequest) (*ClonePolicyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ClonePolicy not implemented")
}
func (UnimplementedPolicyServiceServer) GetPoliciesSummary(context.Context, *GetPoliciesSummaryRequest) (*GetPoliciesSummaryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPoliciesSummary not implemented")
}
func (UnimplementedPolicyServiceServer) GetFilterDefinitions(context.Context, *GetFilterDefinitionsRequest) (*GetFilterDefinitionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetFilterDefinitions not implemented")
}
