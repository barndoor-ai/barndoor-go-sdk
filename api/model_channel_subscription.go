...
// ChannelSubscription One alert type this channel is subscribed to.
...
func NewChannelSubscription(alertType AlertType) *ChannelSubscription {
...
func (o *ChannelSubscription) GetAlertType() AlertType {
	if o == nil {
		var ret AlertType
		return ret
	}
...
func (o *ChannelSubscription) GetAlertTypeOk() (*AlertType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ChannelSubscription) SetAlertType(v AlertType) {
	o.AlertType = v
}
